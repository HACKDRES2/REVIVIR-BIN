...
figlet -f term by. Hackdres [Vip] -c    
figlet -f term ____________________________________ -c 
echo ""
figlet -f term youtube https://youtube.com/channel/UCTSAjBuSJiqSYXd_dqg4qBg -c 
figlet -f term ____________________________________ -c
echo ""    
...
P=$((R1 + R2))
echo ""
figlet -f term =============== extrapolacion hackdres num. 2 ===============  -c
echo ""
...
echo ""
figlet -f term creditos hackdres oficial -c
echo ""
